...
# Model parameters
parser.add_argument('--model_cfg', default='', type=str,
                    help='location to the configuration file that defines the model')
parser.add_argument('--model', default='final', type=str, metavar='MODEL',
...
def main():
    ...
    net_dict= json.load(open(args.model_cfg))
