...
# Random Erasing
parser.add_argument('--random_erase', action='store_true', default=False, help='use random erase')
...
# fixres
parser.add_argument('--fixres', action='store_true', default=False, help='use fixres')
...
net = MobileNetV3(config, num_classes=10)
